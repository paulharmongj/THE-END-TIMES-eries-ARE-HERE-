...
All of the modulus roots for the ARMA(17,0,0) model are greater than 1, this indicates that the model is stationary. There appears to be potential quasi periodicity at the yearly intervals; 2.13, 5.98, 2.44, 2.92, 3.30, 8.91, 4.39, and 19.3 years/observations per a cycle.   
...
The estimated "intercept" for the AR(17) model is 113.8428, with an associated 95\% confidence interval of (102.9768,124.7088). The mean number of days of ice on the lake each year is estimated to be 113.8428. To find the actual estimated intercept
...
\item %5
Examining the confidence intervals for all of the lower order autoregressive coefficients will tell us if they are different from zero at the 5\% significance. We can see that very few of the intervals do not contain zero; only the intervals for the second and sixth lags in fact are detectably different from zero.\\
